...
## What I want next
I'm looking for a technical leadership role with signification hands-on time (20% +). I love both code and caring for humans. I can go without one of them on the medium term (few years), but I'll eventually start to miss it. Right now, I'm missing code a lot. I have an interest in developer experience and tooling, especially at the AST level (e.g., linting, codemods, etc).
